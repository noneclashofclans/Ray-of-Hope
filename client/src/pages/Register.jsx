  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://ray-of-hope-back.onrender.com/api/auth/register",
        {
      ...
      if (response.status === 201) {
        toast.success("Registration successful! Welcome to Ray of Hope.", {
          id: loadingToast,
        });
      ...
      <main className="lgl-main">
        ...
        <div className="lgl-left">
          <div className="lgl-left-inner">
            <p className="lgl-eyebrow">Join the mission</p>
            <h1 className="lgl-left-h1">
              Start<br />making a<br /><span className="lgl-accent">difference.</span>
            </h1>
            <p className="lgl-left-sub">
              Create an account to stay updated on our latest initiatives in Odisha and find ways to contribute to the community.
            </p>
        ...
        <div className="lgl-right">
          <div className="lgl-form-card">
            ...
            <h2 className="lgl-form-title">Create account</h2>
            <p className="lgl-form-sub">Fill in your details to get started.</p>

            <form onSubmit={handleSubmit}>
              <div className="lgl-field">
                <label className="lgl-label">Full name</label>
                <div className="lgl-input-wrap">
                  <i className="bi bi-person lgl-input-icon" />
                  <input
                    type="text"
                    name="username"
                    className="lgl-input"
              ...
              <div className="lgl-field">
                <label className="lgl-label">Phone number</label>
                <div className="lgl-input-wrap">
                  <i className="bi bi-telephone lgl-input-icon" />
                  <input
                    type="tel"
                    name="phone"
                    className="lgl-input"
            ...
            <p className="lgl-register-link">
              ...
              <Link to="/login" className="lgl-link">Sign in</Link>
            </p>
          </div>
        </div>
      </main>
